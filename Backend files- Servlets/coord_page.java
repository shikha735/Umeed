...
public class coord_page extends HttpServlet
{
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
	{
		...
		out.println("<div id='onecolumn'><h2>Welcome Coordinator!!</h2>");
		...
		try
		{
			...
			if(!con.isClosed())
			{
				String query="select sch from umeed_coord where idno='"+username+"' and pwd='"+password+"'";
